...
/**
 * Interface used to define a "tokenizer"-style parser.
 * <p/>
 * Tokenizers are intended to wrap an input source of data then be run in a
 * loop, scanning for and generating tokens from the input on-demand.
 * 
 ...
 */
public interface ITokenizer<IT, TT, VT, ST> extends IParser<IT, TT, VT, ST> {
